import { OttieTheme, ThemeName } from './types';
export * from './types';

export const emeraldTheme: OttieTheme = {
  name: 'emerald',
  label: 'Moss Green',
  colors: {
    bgPage: '#f6faf5',
...
export const riverBlueTheme: OttieTheme = {
  name: 'river',
  label: 'River Blue',
  colors: {
    bgPage: '#f0f9ff',
    ...
    pastelPurpleText: '#581c87',
    pastelGreen: '#e0f2fe',
    pastelGreenBorder: '#bae6fd',
    pastelGreenText: '#0369a1',
  },
  radii: {
    sm: '12px',
    md: '18px',
...
export const themes: Record<ThemeName, OttieTheme> = {
  emerald: emeraldTheme,
  river: riverBlueTheme,
};
