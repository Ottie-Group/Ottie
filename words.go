...
// Standard BIP-39 English Wordlist excerpt (curated 2048 words or clean distinct words for mnemonic security)
var bip39WordList = []string{
	...
	"oven", "over", "own", "owner", "oyster", "ozone", "pact", "paddle", "page", "pair",
	...
	"science", "scissors", "scooter", "scope", "score", "scout", "scrap", "screen", "script", "scrub",
	...
	"tower", "town", "toy", "track", "trade", "traffic", "train", "transfer", "trap", "trash",
...
// GenerateMnemonicPhrase selects n cryptographically secure random words from the BIP-39 wordlist.
func GenerateMnemonicPhrase(numWords int) (string, error) {
	if numWords <= 0 {
		numWords = 12
	}
	total := big.NewInt(int64(len(bip39WordList)))
...
// NormalizePhrase cleans up whitespace and normalizes words to lowercase.
